    ...
    <div className={styles.container}>
      ...
      <div className='container'>
        <div className="alert alert-warning d-flex align-items-center my-5" role="alert">
          ...
          <div className='px-3'>
            Please Note: Wake Relief will be closed from <b>8/1/2022 - 8-3/2022</b> for maintenance. Please send us an email at admin@wakerelief.org with any questions or concerns. Thank you!
          </div>
        </div>
      </div>
